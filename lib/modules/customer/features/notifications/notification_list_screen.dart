...
import 'package:rich_food/modules/customer/features/notifications/widgets/notification_card.dart';
...
import '../../../sales_man/models/notification_model.dart';
import 'notification_controller.dart';

class CustomerNotificationListScreen extends StatelessWidget {
  const CustomerNotificationListScreen({super.key, this.message});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<CustomerNotificationController>(
