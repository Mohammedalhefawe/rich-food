...
import 'package:rich_food/modules/sales_man/models/price_model.dart';
import 'package:rich_food/modules/sales_man/features/prices/widgets/prices_card.dart';
...
class PriceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<PriceListController>(
        builder: (controller) {
