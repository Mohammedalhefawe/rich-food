...
class AreaSelectionToEditWidget extends StatefulWidget {
  const AreaSelectionToEditWidget({super.key});

  @override
  State<AreaSelectionToEditWidget> createState() =>
      _AreaSelectionToEditWidgetState();
}

class _AreaSelectionToEditWidgetState extends State<AreaSelectionToEditWidget> {
