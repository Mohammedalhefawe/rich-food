...
class AreaSelectionToAddWidget extends StatefulWidget {
  const AreaSelectionToAddWidget({super.key});

  @override
  State<AreaSelectionToAddWidget> createState() =>
      _AreaSelectionToAddWidgetState();
}

class _AreaSelectionToAddWidgetState extends State<AreaSelectionToAddWidget> {
